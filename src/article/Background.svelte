<script>
    ...
    function createDot(x, y, z, radius){
        ...
        const material = new THREE.MeshBasicMaterial( { color: 0xEEEEEE, opacity: opacity_sphere, transparent: true } );
    ...
    function createLine(x1, y1, z1, x2, y2, z2){
        ...
        const material = new THREE.LineBasicMaterial( { color: 0xEEEEEE, opacity: opacity_line, transparent: true } );
